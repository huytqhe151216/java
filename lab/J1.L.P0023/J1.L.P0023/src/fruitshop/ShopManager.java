...
/**
 * This class that can create new fruit products and store, setup the quantity
 * of products in the store, allow customers to choose products.
 *
 * @author HuyTQ
 */
public class ShopManager {
    ...
    private int fruitId = 1; // initialize fruidId = 1
    private int orderId = 1; // initializa orderId = 1

    /**
     * This method displayMainScreen all fruit that exist in shop.
     */
    ...
    /**
     * This method display all orders that buyer add and total money of
    ...
    private void shopping() {
        ...
        while (true) {
            displayFruits();
            int item = inputReader.getInputIdFruit(fruitsList);
            Fruit fruit = getFruitById(item);
            // Check that fruit have quantity greater than 0
            if (fruit.getQuantity() == 0) {
                System.out.println("There are no product" + fruit.getName() + " in shop");
            ...
            fruit.setQuantity(fruit.getQuantity() - quantity);      // Update fruit quantity after it was brought.
