                    ...
                    <div class="col-md-9">
                        <div class="ibox">
                            <div class="ibox-title">
                                <span class="pull-right">(<strong>${cart.size()}</strong>) sản phẩm</span>
                                <h5>${cart==null || cart.size()==0?"Giỏ hàng trống":"Danh sách sản phẩm trong giỏ hàng"}</h5>
                            </div>
                                            ...
                                            <tbody>
                                                <c:forEach items="${cart.items}" var="c">
                                                    <tr >
                                                        ...
                                                        <td>
                                                            <p class="price">${c.getKey().price} đồng </p>
                                                        ...
                                                        <td>
                                                                ...
                                                                <p class="price">${c.getKey().price*c.getValue()} đồng</p>
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="m-t-sm">
                                    <c:if test="${sessionScope.cart.size()!=0}">
                                        <div class="btn-group">
                                        <a href="order" class="btn btn-primary btn-sm">Đặt hàng ngay</a>

                                    </div>
                                    </c:if>
                                    <div class="btn-group">
                                        <a href="WebDoCau" class="btn btn-primary btn-sm">Trở về trang chủ</a>
