...
public class takeAttendance extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CourseScheduleDAO csDAO = new CourseScheduleDAO();
        Map<String, ArrayList<Integer>> list = new HashMap<>();
        int cid = Integer.parseInt(request.getParameter("cid"));
        list = csDAO.getDateAndSlot(cid);
        request.setAttribute("cs", list);
        request.setAttribute("cid", cid);
        RequestDispatcher dispatcher = request.getRequestDispatcher("viewslot.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("cslot", slot);
        processRequest(request, response);
    }
